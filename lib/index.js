function _batchProcess (source, options, processFn) {
  var optionsObject;
  var fetchFn;
  ...
  return batchProcess(fetchFn, optionsObject, processFn);
}
...
function batchProcess (fetchFn, options, processFn) {
